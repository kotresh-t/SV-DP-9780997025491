...
class driver extends uvm_driver #(generic_txn);
  ...
  protocol_driver_impl protocol_impl;
  ...
  function void build_phase(uvm_phase phase);
    ...
    `uvm_info("driver", $sformatf("Selected protocol: %s", protocol_name), UVM_LOW)
  endfunction
  ...
  task run_phase(uvm_phase phase);
    ...
    repeat(3) begin
      ...
      protocol_impl.send_addr_phase(txn.addr);
      protocol_impl.send_data_phase(txn.data);
      protocol_impl.receive_response(resp);
