...
interface class operation_mode; 
...
class normal_mode implements operation_mode; 
...
class power_saving_mode implements operation_mode; 
...
class high_performance_mode implements operation_mode; 
